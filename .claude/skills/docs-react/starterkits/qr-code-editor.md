...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new React application with QR Code Editor integration.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-qr-code-editor-ts-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a React component using the official CE.SDK React wrapper (e.g., `QRCodeEditor.tsx`):
    ...
    Import and use the QR Code Editor component in your app:
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the QR Code Editor into an existing React application. This adds the editor configuration to your current project structure.
