...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new React application with Airtable Image Editor integration.
    ...
    Create a React component using the official CE.SDK React wrapper (e.g., `AirtableImageEditor.tsx`):
    ...
    const initWithApiKey = (cesdk: any) =>
      initAirtableImageEditor(cesdk, { airtableApiKey: AIRTABLE_API_KEY });
    ...
    Import and use the Airtable Image Editor component in your app:
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Airtable Image Editor into an existing React application. This adds the editor configuration to your current project structure.
...
The Airtable Image Editor includes Airtable image integration plus full design editing capabilities.
...
- **Get your API key**: Visit [Airtable account settings](https://support.airtable.com/docs/creating-and-using-api-keys-and-access-tokens) to get your key
