...
**Navigation:** [Starter Kits](./starterkits.md) > [Extensibility](./starterkits/extensibility.md) > [InDesign Template Import](./starterkits/indesign-template-import.md)
...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-indesign-template-import-react-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
> - [View source on GitHub](https://github.com/imgly/starterkit-indesign-template-import-react-web/tree/v$UBQ_VERSION$)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone InDesign Template Import project. This creates a complete, ready-to-run application.

    ## Step 1: Clone the Repository

    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-indesign-template-import-react-web.git
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-indesign-template-import-react-web starterkit-indesign-template-import-react-web
      </TerminalTab>
    </TerminalTabs>
    ...
    <TerminalTabs syncKey="package-manager">
      <TerminalTab label="npm">
        cd starterkit-indesign-template-import-react-web
        npm install
      </TerminalTab>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the InDesign Template Import into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-indesign-template-import-react-web.git
        cp -r starterkit-indesign-template-import-react-web/src/imgly ./src/imgly
        rm -rf starterkit-indesign-template-import-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-indesign-template-import-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export default function DesignEditor() {
      return (
        <CreativeEditor
          ...
          init={initInDesignTemplateImportEditor}
          width="100vw"
          height="100vh"
        />
      );
...
## Understanding the IDML Importer

The IDML importer parses Adobe InDesign files and converts them to editable CE.SDK scenes. It supports:

- **Layout Preservation**: Maintains the original page layout from InDesign
- **Text Frames**: Converts text frames to editable CE.SDK text blocks
- **Image Frames**: Imports image frames with proper positioning and transformations
- **Multi-Page Support**: Handles documents with multiple pages
- **Paragraph Styles**: Preserves paragraph and character styling

### Import Result Structure

```typescript
interface IdmlImportResult {
...
```typescript
const result = await importIdmlFile(idmlBlob, "document.idml");
...
The InDesign Template Import starter kit enables professional publishing workflows.

<CapabilityGrid
features={[
{
title: 'IDML File Import',
description:
'Import Adobe InDesign files directly into the editor with full layout support.',
imageId: 'transform',
},
{
title: 'Layout Preservation',
description:
'Maintain the original page layout, columns, and text frames from InDesign.',
imageId: 'templating',
},
{
title: 'Text Frame Editing',
description:
'Edit imported text frames with comprehensive typography controls and font management.',
imageId: 'text-editing',
},
{
title: 'Multi-Page Support',
description:
'Work with multi-page documents and preserve page structure from InDesign.',
...
description:
'Build publishing systems using imported InDesign templates and assets.',
...
### IDML file doesn't import correctly

- **Check file format**: Ensure the IDML file is in a supported format (exported from InDesign)
