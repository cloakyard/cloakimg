...
**Navigation:** [Starter Kits](./starterkits.md) > [Creative Automation](./starterkits/creative-automation.md) > [Design Generator](./starterkits/design-generation.md)
...
> - [View source on GitHub](https://github.com/imgly/starterkit-automatic-design-generation-react-web/tree/v$UBQ_VERSION$)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Automatic Design Generation project. This creates a complete, ready-to-run React application.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-automatic-design-generation-react-web starterkit-automatic-design-generation-react-web
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Automatic Design Generation into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-automatic-design-generation-react-web.git
        cp -r starterkit-automatic-design-generation-react-web/src/imgly ./src/imgly
        rm -rf starterkit-automatic-design-generation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-automatic-design-generation-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    <Tabs syncKey="editor-mode">
      <TabItem label="Design">
        ...
        import { initDesignGenerationDesignEditor } from './imgly';

        export default function DesignEditor() {
          return (
            <CreativeEditor
              config={{ baseURL: '/assets' }}
              init={initDesignGenerationDesignEditor}
              width="100vw"
              height="100vh"
            />
          );
      ...
      <TabItem label="Video">
        ```tsx
        import CreativeEditor from '@cesdk/cesdk-js/react';
        import { initDesignGenerationVideoEditor } from './imgly';

        export default function DesignEditor() {
          return (
            <CreativeEditor
              config={{ baseURL: '/assets' }}
              init={initDesignGenerationVideoEditor}
              width="100vw"
              height="100vh"
            />
          );
...
The Automatic Design Generation starter kit includes everything needed for programmatic design generation.

<CapabilityGrid
features={[
{
title: 'Multi-Size Generation',
description:
'Generate designs in multiple sizes simultaneously for social media, banners, and marketing materials.',
imageId: 'transform',
},
{
title: 'Image & Video Output',
description:
'Switch between static image and animated video output to suit your content needs.',
imageId: 'filters',
},
{
title: 'Built-in Preview',
description:
'Preview and edit generated designs using the full CE.SDK editor before final export.',
imageId: 'green-screen',
},
{
title: 'Template-Based Design',
description:
'Start from templates and programmatically swap content, colors, and assets.',
imageId: 'text-editing',
},
{
title: 'Batch Export',
description:
'Export all selected sizes at once with configurable output formats and quality.',
imageId: 'asset-libraries',
},
{
title: 'Client-Side Processing',
description:
'All generation and export happens in the browser—no server required.',
imageId: 'client-side',
},
]}
/>
