...
> **Caution:** **Cross-platform users:** Mobile SDKs (iOS, Android) do not yet support scenes without a mode. If your application creates scenes on Web and loads them on mobile, you **must** set an explicit mode. See [How to Keep Using Legacy Mode](#how-to-keep-using-legacy-mode) below.
...
> **Caution:** Mobile SDKs (iOS, Android) do not yet support scenes without a mode. If you create scenes on Web and load them on mobile without an explicit mode, mobile SDKs will not be able to handle the scene correctly.
