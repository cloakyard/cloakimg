...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.asset.addLocalSource("my-server-templates", undefined, async (asset) => {
      if (asset.meta?.uri) {
    ...
    cesdk.ui.registerComponent("my-server-assets.dock", ({ builder: { Button } }) => {
...
const MOCK_AUDIO: MockAsset[] = [
  {
    ...
    thumbnail: "https://cdn.img.ly/assets/demo/v3/ly.img.audio/thumbnails/dance_harder.jpg",
    duration: 212.5,
...
const MOCK_STICKERS: MockAsset[] = [
  {
    ...
    thumbnail: "https://cdn.img.ly/assets/v1/ly.img.sticker/thumbnails/doodle/doodle_camera.png",
    width: 2048,
    height: 1339,
  },
];
...
const MOCK_TEMPLATES: MockAsset[] = [
  ...
  },
  {
    ...
    thumbnail: "https://cdn.img.ly/assets/demo/v3/ly.img.video.template/thumbnails/my-plants.png",
  },
];
...
function filterByQuery<T extends { title: string }>(items: T[], query: string | undefined): T[] {
