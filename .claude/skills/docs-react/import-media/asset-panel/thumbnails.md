  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.asset.addAssetToSource("custom-audio", {
      ...
      meta: {
        ...
        thumbUri: "https://cdn.img.ly/assets/demo/v3/ly.img.audio/thumbnails/dance_harder.jpg", // Waveform visualization (image, UI-only)
        previewUri: "https://cdn.img.ly/assets/demo/v3/ly.img.audio/audios/dance_harder.m4a", // Preview clip - set as block property on canvas
    ...
    engine.asset.addAssetToSource("custom-audio", {
      ...
      meta: {
        ...
        thumbUri: "https://cdn.img.ly/assets/demo/v3/ly.img.audio/thumbnails/audio-wave.png",
        previewUri: "https://cdn.img.ly/assets/demo/v3/ly.img.audio/audios/far_from_home.m4a",
    ...
    engine.asset.addAssetToSource("custom-audio", {
      ...
      meta: {
        ...
        thumbUri: "https://cdn.img.ly/assets/demo/v3/ly.img.audio/thumbnails/elsewhere.jpg",
        previewUri: "https://cdn.img.ly/assets/demo/v3/ly.img.audio/audios/elsewhere.m4a",
        mimeType: "audio/x-m4a",
        blockType: "//ly.img.ubq/audio",
        duration: "121.2",
      },
