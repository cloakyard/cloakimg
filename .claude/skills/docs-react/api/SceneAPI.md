...
engine.scene.applyTemplateFromURL(
  "https://cdn.img.ly/assets/demo/v4/ly.img.template/templates/cesdk_postcard_1.scene",
);
```
...
engine.scene.unstable_enableCameraPositionClamping(
  [scene],
  10.0,
  10.0,
  10.0,
