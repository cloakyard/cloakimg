...
Core type definitions used throughout the CE.SDK API.
...
Types: MimeType, ImageMimeType, AudioMimeType, VideoMimeType, ApplicationMimeType
...
Types: Settings, SettingKey, SettingValueType
