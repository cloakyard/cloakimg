...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-import-media-retrieve-mimetype-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const archiveUrl = "https://cdn.img.ly/assets/templates/starterkits/16-9-fashion-ad.zip";
