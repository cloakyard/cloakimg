...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-import-media-asset-library-basics-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.engine.asset.addSource({
      ...
      applyAsset: async (assetResult) => cesdk.engine.asset.defaultApplyAsset(assetResult),
    });
