...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-video-transform-scale-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.block.setString(explanation1, "text/text", "150% from top-left anchor");
    ...
    engine.block.setString(explanation2, "text/text", "150% from center anchor");
    ...
    engine.block.setString(explanation3, "text/text", "150% width, height unchanged");
    ...
    engine.block.setString(explanation4, "text/text", "Transform locked - cannot scale");
    ...
    engine.block.setColor(engine.block.getFill(explanation4), "fill/color/value", {
      r: 1,
      g: 1,
      b: 1,
      a: 1,
