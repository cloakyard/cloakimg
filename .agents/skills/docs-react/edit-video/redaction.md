...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-video-redaction-browser/index.html)
...
const VIDEOS = {
  ...
  nature1: "https://cdn.img.ly/assets/demo/v3/ly.img.video/videos/pexels-taryn-elliott-8713109.mp4",
  nature2: "https://cdn.img.ly/assets/demo/v3/ly.img.video/videos/pexels-taryn-elliott-8713114.mp4",
};

// Labels for each redaction technique
const LABELS = ["Radial Blur", "Full-Block Blur", "Pixelization", "Solid Overlay", "Time-Based"];
