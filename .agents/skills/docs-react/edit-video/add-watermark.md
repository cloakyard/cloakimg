...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-video-add-watermark-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    try {
      ...
      // eslint-disable-next-line no-console
      console.log("Video watermark guide initialized. Click play button to start playback.");
    }
  }
}
