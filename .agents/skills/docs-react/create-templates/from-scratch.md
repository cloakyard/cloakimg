...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-templates-from-scratch-browser/index.html)
    ...
    cesdk.ui.registerComponent("save.string", ({ builder }) => {
      builder.Button("save-string-btn", {
        ...
        onClick: async () => {
          ...
          console.log("Template saved as string:", templateString.substring(0, 100) + "...");
    ...
    cesdk.ui.registerComponent("save.archive", ({ builder }) => {
      builder.Button("save-archive-btn", {
        ...
        onClick: async () => {
          ...
          console.log("Template saved as archive:", templateArchive.size, "bytes");
