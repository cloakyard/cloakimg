...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-templates-add-dynamic-content-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const logo = await engine.block.addImage("https://img.ly/static/ubq_samples/imgly_logo.jpg", {
...
// Create heading with company variable
const headingText = engine.block.create("text");
engine.block.replaceText(headingText, "Welcome to {{companyName}}, {{firstName}} {{lastName}}.");
```
