...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-templates-dynamic-content-text-variables-browser/index.html)
...
Company: {{company}}`;
    ...
    cesdk.ui.registerPanel("ly.img.variablesManager", ({ builder, engine: panelEngine, state }) => {
...
CE.SDK includes an _Insert Variable_ dropdown in the text editing canvas menu that allows template authors to insert variable tokens into text blocks.
...
> **Note:** CE.SDK does not include a built-in UI for end users to _create_ or _manage_
