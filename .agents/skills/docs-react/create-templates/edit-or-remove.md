...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-templates-edit-or-remove-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.block.replaceText(subtitleBlock, 'Browse "My Templates" at the bottom of the dock');
    ...
    // eslint-disable-next-line no-console
    console.log('Original template applied - browse "My Templates" in the dock');
  }
}
