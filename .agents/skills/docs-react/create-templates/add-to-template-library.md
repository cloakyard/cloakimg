...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-templates-add-to-template-library-browser/index.html)
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.ui.insertOrderComponent(
      { in: "ly.img.navigation.bar", position: "end" },
      {
        ...
        children: ["ly.img.saveScene.navigationBar", "ly.img.exportArchive.navigationBar"],
      },
    );
  }
}
