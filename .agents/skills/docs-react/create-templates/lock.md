...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-templates-lock-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.ui.registerComponent("ly.img.roleToggle.navigationBar", ({ builder }) => {
        ...
        children: () => {
          ...
          builder.Button("adopter", {
            ...
            onClick: () => {
              ...
              cesdk.ui.closePanel("//ly.img.panel/inspector/placeholderSettings");
