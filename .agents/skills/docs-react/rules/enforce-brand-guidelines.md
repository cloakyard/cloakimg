...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-rules-enforce-brand-guidelines-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.block.replaceText(legalText, "\u00A9 2024 Company Name. All rights reserved.");
    ...
    const isContentEditable = engine.block.isAllowedByScope(contentBlock, "fill/change");
