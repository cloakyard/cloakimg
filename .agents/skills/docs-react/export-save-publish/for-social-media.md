...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-export-save-publish-export-for-social-media-browser/index.html)
    ...
    const exportVideo = async () => {
      ...
      const videoBlob = await engine.block.exportVideo(currentPage, {
        ...
        onProgress: (renderedFrames, encodedFrames, totalFrames) => {
          ...
          console.log(`Export progress: ${percent}% (${encodedFrames}/${totalFrames} frames)`);
        },
      });
