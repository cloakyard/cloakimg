...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-export-save-publish-for-printing-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.ui.showNotification({
      message: "Use the export buttons to export print-ready PDFs with different options",
      type: "info",
      duration: "infinite",
    });
  }
