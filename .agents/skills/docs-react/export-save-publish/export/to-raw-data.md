...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-export-save-publish-export-to-raw-data-browser/index.html)
...
class Example implements EditorPlugin {
   ...
   */
  private toGrayscale(pixelData: Uint8Array, _width: number, _height: number): Uint8Array {
