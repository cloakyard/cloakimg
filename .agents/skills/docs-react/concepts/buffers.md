...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-concepts-buffers-browser/index.html)
...
function createWavFile(samples: Float32Array, sampleRate: number, numChannels: number): Uint8Array {
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.editor.setBufferData(demoBuffer, 0, new Uint8Array([1, 2, 3, 4, 5, 6, 7, 8]));
    ...
    console.log("Demo buffer length after resize:", engine.editor.getBufferLength(demoBuffer));
    ...
    console.log("Note: Audio playback requires user interaction in most browsers");
  }
}
