...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-concepts-design-units-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    // eslint-disable-next-line no-console
    console.log("- A4 width (210mm) will export as", 210 * (300 / 25.4), "pixels");
    // eslint-disable-next-line no-console
    console.log("- A4 height (297mm) will export as", 297 * (300 / 25.4), "pixels");
