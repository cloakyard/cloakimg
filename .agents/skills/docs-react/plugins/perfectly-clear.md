...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-perfectlyclear-editor/index.html)
...
await cesdk.addPlugin(PerfectlyClearPlugin({ apiKey: "YOUR_PFC_API_KEY" }));
```
...
| `Timing-Allow-Origin` _(optional)_ | `*`                                            | Exposes Resource Timing details for performance debugging across origins  |
