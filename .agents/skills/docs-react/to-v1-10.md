...
Starting with `v1.10` we fully embrace [Asset Sources](./concepts/assets.md) as our standard interface for asset management.
...
To keep offering the contained assets in your deployment, use our new [convenience functions](./to-v1-10-1ff469/#21-making-use-of-default-and-demo-asset-sources.md) to instantiate asset sources holding these assets.
