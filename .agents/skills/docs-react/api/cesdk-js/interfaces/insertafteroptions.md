...
| -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `A` _extends_ `Exclude`\<[`UIArea`](./api/cesdk-js/type-aliases/uiarea.md), [`PositionalUIArea`](./api/cesdk-js/type-aliases/positionaluiarea.md)> | `Exclude`\<[`UIArea`](./api/cesdk-js/type-aliases/uiarea.md), [`PositionalUIArea`](./api/cesdk-js/type-aliases/positionaluiarea.md)> |
...
| `at?`       | `A` _extends_ `"ly.img.dock"` ? [`DockPosition`](./api/cesdk-js/type-aliases/dockposition.md) : `never` | Dock position: `'left'`, `'right'`, or `'bottom'`. Defaults to `'left'`. Only available for `'ly.img.dock'`. | [`BaseInsertOptions`](./api/cesdk-js/interfaces/baseinsertoptions.md).[`at`](./api/cesdk-js/interfaces/baseinsertoptions.md)   |
| `after`     | [`ComponentMatcher`](./api/cesdk-js/type-aliases/componentmatcher.md)                                   | Insert after this component.                                                                                 | -                                                                                                                              |
| `before?`   | `never`                                                                                                 | -                                                                                                            | -                                                                                                                              |
| `position?` | `never`                                                                                                 | -                                                                                                            | -                                                                                                                              |
