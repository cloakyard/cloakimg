...
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `A` _extends_ [`UIAreaSpecifier`](./api/cesdk-js/type-aliases/uiareaspecifier.md) | [`UIAreaSpecifier`](./api/cesdk-js/type-aliases/uiareaspecifier.md) |
