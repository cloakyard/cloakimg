...
Represents the context for determining if a feature is enabled.
This type includes the `CreativeEngine` instance.

## Properties

| Property | Type                                                             |
| -------- | ---------------------------------------------------------------- |
| `engine` | [`AddImageOptions`](./api/cesdk-js/variables/addimageoptions.md) |
