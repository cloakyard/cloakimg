...
```ts
type EditorPluginContext = AddImageOptions & object;
```

Represents the context for an editor plugin.
...
| Name     | Type                                                               |
| -------- | ------------------------------------------------------------------ |
| `cesdk?` | [`CreativeEditorSDK`](./api/cesdk-js/classes/creativeeditorsdk.md) |
