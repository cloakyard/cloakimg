...
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `P` _extends_ [`ComponentPayload`](./api/cesdk-js/interfaces/componentpayload.md) | [`ComponentPayload`](./api/cesdk-js/interfaces/componentpayload.md) |
...
| Type Parameter                                                    |
| ----------------------------------------------------------------- |
| `T` _extends_ [`PanelId`](./api/cesdk-js/type-aliases/panelid.md) |
...
| Type Parameter                                                  |
| --------------------------------------------------------------- |
| `A` _extends_ [`UIArea`](./api/cesdk-js/type-aliases/uiarea.md) |
...
cesdk.ui.setComponentOrder({ in: "ly.img.canvas.bar", at: "top" }, ["ly.img.settings.canvasBar"]);

// Set order with edit mode context
cesdk.ui.setComponentOrder({ in: "ly.img.inspector.bar", when: { editMode: "Text" } }, [
...
| Type Parameter                                                                    |
| --------------------------------------------------------------------------------- |
| `A` _extends_ [`UIAreaSpecifier`](./api/cesdk-js/type-aliases/uiareaspecifier.md) |
...
`A` _extends_ [`UIArea`](./api/cesdk-js/type-aliases/uiarea.md) ? [`UpdateResult`](./api/cesdk-js/interfaces/updateresult.md)\<`A`> : [`MultiAreaUpdateResult`](./api/cesdk-js/type-aliases/multiareaupdateresult.md)
...
cesdk.ui.updateOrderComponent({ in: "ly.img.dock", match: "ly.img.*" }, { disabled: true });

// Update using function
cesdk.ui.updateOrderComponent({ in: "ly.img.inspector.bar", match: "first" }, (component) => ({
  key: `${component.id}-modified`,
}));
...
`A` _extends_ [`UIArea`](./api/cesdk-js/type-aliases/uiarea.md) ? [`RemoveResult`](./api/cesdk-js/interfaces/removeresult.md)\<`A`> : [`MultiAreaRemoveResult`](./api/cesdk-js/type-aliases/multiarearemoveresult.md)
...
cesdk.ui.insertOrderComponent({ in: "ly.img.dock", after: "ly.img.spacer" }, [
  "my.button.1",
  "my.button.2",
  "my.button.3",
]);
...
cesdk.ui.insertOrderComponent({ in: "ly.img.dock", before: "ly.img.separator" }, "my.button");
...
cesdk.ui.insertOrderComponent({ in: "ly.img.dock", position: "start" }, [
  "first.button",
  "second.button",
]);

// Insert at index
cesdk.ui.insertOrderComponent({ in: "ly.img.dock", position: 2 }, "my.third.button");

// Insert at negative index (from end)
cesdk.ui.insertOrderComponent({ in: "ly.img.dock", position: -1 }, "my.before.last.button");
```
...
cesdk.ui.setOrderContext({ in: "ly.img.caption.panel" }, { view: "style" });
