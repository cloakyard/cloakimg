...
| --------- | ------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| `id`      | `K`                                                                                                                                   | The action id.                     |
| ...`args` | [`EngineActionsRegistry`](./api/engine/interfaces/engineactionsregistry.md)\[`K`] _extends_ (...`args`) => `any` ? `A` : `unknown`\[] | Arguments forwarded to the action. |

##### Returns

`Promise`\<[`EngineActionsRegistry`](./api/engine/interfaces/engineactionsregistry.md)\[`K`] _extends_ (...`args`) => `R` ? `Awaited`\<`R`> : `unknown`>
