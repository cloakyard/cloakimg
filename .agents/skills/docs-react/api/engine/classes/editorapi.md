...
```javascript
const metrics = await engine.editor.getFontMetrics(
...
| Type Parameter                                                        |
| --------------------------------------------------------------------- |
| `K` _extends_ keyof [`Settings`](./api/engine/interfaces/settings.md) |
...
| Type Parameter                                                                        |
| ------------------------------------------------------------------------------------- |
| `T` _extends_ keyof [`SettingEnumType`](./api/engine/type-aliases/settingenumtype.md) |
