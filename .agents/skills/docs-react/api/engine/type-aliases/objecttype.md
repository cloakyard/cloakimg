...
Refer to [ObjectTypeShorthand](./api/engine/type-aliases/objecttypeshorthand.md) and [ObjectTypeLonghand](./api/engine/type-aliases/objecttypelonghand.md) for more details.
