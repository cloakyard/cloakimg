...
Refer to [ShapeTypeShorthand](./api/engine/type-aliases/shapetypeshorthand.md) and [ShapeTypeLonghand](./api/engine/type-aliases/shapetypelonghand.md) for more details.
