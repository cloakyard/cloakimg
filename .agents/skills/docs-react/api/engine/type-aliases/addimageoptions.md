...
| ---------------------- | --------------------------------------------------------------------- | ------------------------------------------------------- |
| `sizeMode?`            | [`SizeMode`](./api/engine/type-aliases/sizemode.md)                   | How the image should be sized and positioned            |
...
| `size?`                |                                                                       | `number`                                                | \{ `width`: `number`; `height`: `number`; } | Size for the image - can be a number for equal width/height or an object |
