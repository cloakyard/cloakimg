...
Refer to [AnimationTypeShorthand](./api/engine/type-aliases/animationtypeshorthand.md) and [AnimationTypeLonghand](./api/engine/type-aliases/animationtypelonghand.md) for more details.
