...
Refer to [FillTypeShorthand](./api/engine/type-aliases/filltypeshorthand.md) and [FillTypeLonghand](./api/engine/type-aliases/filltypelonghand.md) for more details.
