...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-colors-for-print-spot-browser/index.html)
...
import type { EditorPlugin, EditorPluginContext, SpotColor } from "@cesdk/cesdk-js";
import {
  BlurAssetSource,
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const { block: strokeBlock, fill: strokeBlockFill } = createColorBlock(50, 220, 150, 150);
    // Set fill to white
    ...
    const { block: shadowBlock, fill: shadowBlockFill } = createColorBlock(220, 220, 150, 150);
