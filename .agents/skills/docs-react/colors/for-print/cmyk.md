...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-colors-for-print-cmyk-browser/index.html)
...
import type { CMYKColor, EditorPlugin, EditorPluginContext, RGBAColor } from "@cesdk/cesdk-js";
import {
  BlurAssetSource,
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const { block: strokeBlock, fill: strokeBlockFill } = createColorBlock(220, 220, 150, 150);
    ...
    const { block: shadowBlock, fill: shadowBlockFill } = createColorBlock(390, 220, 150, 150);
    ...
    const convertedRgb = engine.editor.convertColorToColorSpace(cmykGreen, "sRGB");
    // eslint-disable-next-line no-console
