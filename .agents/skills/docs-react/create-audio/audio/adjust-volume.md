...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-audio-audio-adjust-volume-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const audioUri = "https://cdn.img.ly/assets/demo/v3/ly.img.audio/audios/dance_harder.m4a";
    ...
    // eslint-disable-next-line no-console
    console.log(`Low volume audio: ${(engine.block.getVolume(lowVolumeAudio) * 100).toFixed(0)}%`);
    // eslint-disable-next-line no-console
    console.log(`Muted audio - isMuted: ${isMuted}, isForceMuted: ${isForceMuted}`);
