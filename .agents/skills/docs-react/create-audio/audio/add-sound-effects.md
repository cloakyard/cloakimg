...
![Sound Effects Demo showing programmatically generated audio on the timeline](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-audio-add-sound-effects-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const chimeWav = createWavBuffer(sampleRate, SUCCESS_CHIME.totalDuration, (time) => {
      let sample = 0;
    ...
    const melodyWav = createWavBuffer(sampleRate, NOTIFICATION_MELODY.totalDuration, (time) => {
      let sample = 0;
    ...
    const alertWav = createWavBuffer(sampleRate, ALERT_TONE.totalDuration, (time) => {
      let sample = 0;
