...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-audio-add-music-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const audioUri = "https://cdn.img.ly/assets/demo/v3/ly.img.audio/audios/far_from_home.m4a";
...
| `audio/totalDuration`             | `Double` | `"-"`      | The total duration of the audio file., _(read-only)_                                                                                                                                                  |
