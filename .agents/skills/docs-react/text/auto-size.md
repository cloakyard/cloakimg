...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-text-auto-size-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const isAutoFontSize = engine.block.getBool(scaledText, "text/automaticFontSizeEnabled");
    ...
    const hasClippedLines = engine.block.getBool(scaledText, "text/hasClippedLines");
