...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-animation-create-text-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.block.replaceText(text4, "Character by character for typewriter effect");
    ...
    const writingStyleOptions = engine.block.getEnumValues("textAnimationWritingStyle");
    // eslint-disable-next-line no-console
