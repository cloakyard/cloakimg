...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-outlines-shadows-and-glows-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    console.log("Shadow disabled:", !engine.block.isDropShadowEnabled(textBlock));
    engine.block.setDropShadowEnabled(textBlock, wasEnabled);
    console.log("Shadow re-enabled:", engine.block.isDropShadowEnabled(textBlock));
