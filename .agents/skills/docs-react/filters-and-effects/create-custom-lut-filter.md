...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-filters-and-effects-create-custom-lut-filter-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const totalContentHeight = titleHeight + textGap + subTextHeight + imagePadding + imageHeight;
...
// Configure the LUT file URI - this is a tiled PNG containing the color lookup table
const lutUrl = "https://cdn.img.ly/assets/v4/ly.img.filter.lut/LUTs/imgly_lut_ad1920_5_5_128.png";
engine.block.setString(lutEffect, "effect/lut_filter/lutFileURI", lutUrl);
