...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-filters-and-effects-distortion-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    console.log("Liquid effect now disabled:", !engine.block.isEffectEnabled(liquidEffect));
