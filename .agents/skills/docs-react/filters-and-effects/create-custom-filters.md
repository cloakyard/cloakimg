...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-filters-and-effects-add-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const customFilterSource: AssetSource = {
      ...
      async findAssets(queryData: AssetQueryData): Promise<AssetsQueryResult | undefined> {
        ...
        return {
          ...
          currentPage: page,
          nextPage: startIndex + perPage < filteredAssets.length ? page + 1 : undefined,
        };
      },
    ...
    const jsonSourceId = await engine.asset.addLocalAssetSourceFromJSONString(filterConfigJSON);
    ...
    const customFilterResults = await engine.asset.findAssets("my-custom-filters", {
      page: 0,
      perPage: 10,
    });
...
engine.asset.addAssetToSource("ly.img.filter", {
  ...
  meta: {
    uri: "https://cdn.img.ly/assets/v4/ly.img.filter.lut/LUTs/imgly_lut_ad1920_5_5_128.png",
    thumbUri: "https://cdn.img.ly/assets/v4/ly.img.filter.lut/LUTs/imgly_lut_ad1920_5_5_128.png",
    horizontalTileCount: "5",
    verticalTileCount: "5",
    blockType: "//ly.img.ubq/effect/lut_filter",
  },
