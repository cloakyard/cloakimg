...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-open-the-editor-from-video-browser/index.html)
...
async function createSceneFromBlob(engine: CreativeEngine, blob: Blob): Promise<number> {
