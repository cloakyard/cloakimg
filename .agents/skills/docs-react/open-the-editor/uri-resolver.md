...
![CE.SDK URI Resolver demonstration showing custom resolution behavior](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-open-the-editor-uri-resolver-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.editor.setURIResolver((uri, defaultURIResolver) => defaultURIResolver(uri));
    // eslint-disable-next-line no-console
    ...
    const image1 = await engine.block.addImage("https://img.ly/static/ubq_samples/sample_1.jpg", {
      size: imageSize,
    });
    ...
    const image2 = await engine.block.addImage("https://img.ly/static/ubq_samples/sample_2.jpg", {
      size: imageSize,
    });
    ...
    const image3 = await engine.block.addImage("https://img.ly/static/ubq_samples/sample_3.jpg", {
      size: imageSize,
    });
