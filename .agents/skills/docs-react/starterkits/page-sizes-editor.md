...
**Navigation:** [Starter Kits](./starterkits.md) > [Assets](./starterkits/assets.md) > [Page Sizes Editor](./starterkits/page-sizes-editor.md)

---

Automatically adapt the same design or template to different page sizes and easily scale marketing campaigns and print materials across platforms.

![Page Sizes Editor starter kit showing a professional page size selection interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)

> **Reading time:** 10 minutes
>
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-page-sizes-asset-source-ts-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-page-sizes-asset-source-ts-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-page-sizes-asset-source-ts-web/tree/release-$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-page-sizes-asset-source/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new React application with Page Sizes Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-page-sizes-asset-source-ts-web/src/imgly ./src/imgly rm -rf
        starterkit-page-sizes-asset-source-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-page-sizes-asset-source-ts-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Create a React component using the official CE.SDK React wrapper (e.g., `PageSizesEditor.tsx`):

    ```tsx
    import { initPageSizesAssetSource } from './imgly';
    import CreativeEditor from '@cesdk/cesdk-js/react';

    export default function PageSizesEditor() {
      return (
        <CreativeEditor
          config={{ baseURL: '/assets' }}
          init={initPageSizesAssetSource}
          width="100vw"
          height="100vh"
        />
      );
    ...
    ```tsx
    import PageSizesEditor from './components/PageSizesEditor';

    function App() {
      return <PageSizesEditor />;
    }
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing React application. This adds the editor configuration to your current project structure.
...
The Page Sizes Editor uses asset source plugins to provide built-in libraries for templates, stickers, shapes, and fonts. The starter kit includes a curated selection—customize what's included based on your needs.
...
The Page Sizes Editor includes everything needed for professional page size selection.
