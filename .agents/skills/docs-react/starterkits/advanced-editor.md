...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-advanced-design-editor/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create `src/components/AdvancedEditor.tsx` (create the `components/` directory if it doesn't exist) using the official CE.SDK React wrapper:

    ```tsx title="src/components/AdvancedEditor.tsx"
...
Design Editor (Advanced) includes everything needed for professional design editing.
