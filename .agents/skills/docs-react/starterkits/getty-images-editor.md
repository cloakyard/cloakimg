...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-getty-asset-source/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new React application with Getty Images Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-getty-asset-source-ts-web/src/imgly ./src/imgly rm -rf
    ...
    Create a React component using the official CE.SDK React wrapper (e.g., `GettyImagesEditor.tsx`):
    ...
    const initWithProxyUrl = (cesdk: any) =>
      initGettyImagesEditor(cesdk, { gettyProxyUrl: GETTY_PROXY_URL });

    export default function GettyImagesEditor() {
      return (
        <CreativeEditor
    ...
    Import and use the Getty Images Editor component in your app:

    ```tsx
    import GettyImagesEditor from './components/GettyImagesEditor';

    function App() {
      return <GettyImagesEditor />;
    }
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Getty Images Editor into an existing React application. This adds the editor configuration to your current project structure.
...
> **Proxy Server Required:** To use Getty Images, you need a proxy server that handles Getty Images API
> authentication. Set the proxy URL via the `VITE_GETTY_IMAGES_PROXY_URL`
> environment variable or pass it to `initGettyImagesEditor()`.
...
The Getty Images Editor includes Getty Images premium stock photo integration plus full design editing capabilities.
...
- **Check your proxy server**: Ensure your proxy is running and returning valid responses
...
- [Asset Source Plugins](./plugins/asset-sources.md) – Build your own asset
  integrations
