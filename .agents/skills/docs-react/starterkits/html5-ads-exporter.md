...
**Navigation:** [Starter Kits](./starterkits.md) > [Extensibility](./starterkits/extensibility.md) > [HTML5 Ads Exporter](./starterkits/html5-ads-exporter.md)

---

Export static and animated designs as HTML5 ad banners in a customizable, ad-network-ready ZIP file or single HTML file.

![HTML5 Ads Exporter starter kit showing a professional design editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)

> **Reading time:** 10 minutes
>
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-html5-ads-exporter-ts-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-html5-ads-exporter-ts-web/tree/v$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-html5-ads-exporter-ts-web/tree/v$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-html5-ads-exporter/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new React application with HTML5 Ads Exporter integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-html5-ads-exporter-ts-web/src/imgly ./src/imgly
        rm -rf starterkit-html5-ads-exporter-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-html5-ads-exporter-ts-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    Add HTML5 ad export capabilities:
    ...
    <TerminalTabs syncKey="package-manager">
      ...
      <TerminalTab label="pnpm">
        pnpm add @imgly/html-exporter
      </TerminalTab>

      <TerminalTab label="yarn">
        yarn add @imgly/html-exporter
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the HTML5 Ads Exporter into an existing React application. This adds the editor configuration to your current project structure.
...
## Using the HTML5 Exporter

This starter kit includes the `Html5ExportPanelPlugin`, which adds a custom export panel to the editor's navigation bar. The plugin uses [`@imgly/html-exporter`](https://www.npmjs.com/package/@imgly/html-exporter) to convert designs into HTML5 output.

The export panel provides the following options:

- **Format** — Choose between **Embedded** (single self-contained HTML file with base64 assets) or **External** (HTML file with separate asset files, downloadable as ZIP)
- **Text Mode** — Select **HTML Text** (selectable, searchable, CSS-styled) or **Vector** (pixel-perfect, not selectable)
- **Page Selection** — Pick which page to export in multi-page scenes

Two export actions are available from the panel:

- **Export & Preview** — Exports the design as an embedded HTML file and opens it in a new browser tab
- **Download ZIP** — Exports with external format and downloads all files as a ZIP archive

The plugin is registered in `src/imgly/index.ts`:
...
The HTML5 Ads Exporter uses asset source plugins to provide built-in libraries for templates, stickers, shapes, and fonts. The starter kit includes a curated selection—customize what's included based on your needs.
...
The HTML5 Ads Exporter includes everything needed for HTML5 ads export.
