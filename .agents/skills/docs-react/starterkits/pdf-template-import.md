...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-pdf-template-import/index.html)
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the PDF Template Import into an existing React application. This adds the editor configuration to your current project structure.
    ...
    export default function DesignEditor() {
      return (
        <CreativeEditor
          ...
          init={initPdfTemplateImportEditor}
          width="100vw"
          height="100vh"
        />
      );
