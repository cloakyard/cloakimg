...
**Navigation:** [Starter Kits](./starterkits.md) > [Creative Automation](./starterkits/creative-automation.md) > [Export Using Renderer](./starterkits/export-using-renderer.md)
...
![Export Using Renderer starter kit showing a professional design editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-export-using-renderer/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new React application with Export Using Renderer integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-export-using-renderer-ts-web/src/imgly ./src/imgly
        rm -rf starterkit-export-using-renderer-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-export-using-renderer-ts-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Export Using Renderer into an existing React application. This adds the editor configuration to your current project structure.
