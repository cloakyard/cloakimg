...
**Navigation:** [Starter Kits](./starterkits.md) > [Customization](./starterkits/customization.md) > [Theming](./starterkits/theming.md)

---

Effortlessly adapt the UI of the CreativeEditor SDK to best match your app. With Theming you can easily change elements like theme, scaling, and background.

![Theming starter kit showing customizable theme interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)

> **Reading time:** 10 minutes
>
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-theming-react-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-theming-react-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-theming-react-web/tree/release-$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-theming/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Theming project. This creates a complete, ready-to-run application.

    ## Step 1: Clone the Repository

    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-theming-react-web.git
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-theming-react-web starterkit-theming-react-web
      </TerminalTab>
    </TerminalTabs>
    ...
    <TerminalTabs syncKey="package-manager">
      <TerminalTab label="npm">
        cd starterkit-theming-react-web
        npm install
      </TerminalTab>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate theming into an existing web application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-theming-react-web.git
        cp -r starterkit-theming-react-web/src/imgly ./src/imgly
        rm -rf starterkit-theming-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-theming-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
...
The Theming starter kit includes customizable UI styling and branding options.
...
title: 'Color Schemes',
description:
'Apply custom color schemes with primary, secondary, and accent colors to match your brand.',
imageId: 'filters',
},
{
title: 'Light & Dark Modes',
description:
'Switch between light and dark themes or detect system preferences automatically.',
imageId: 'transform',
},
{
title: 'CSS Variables',
description:
'Fine-tune appearance using CSS custom properties for granular control over UI elements.',
imageId: 'green-screen',
},
{
title: 'Font Customization',
description:
'Configure custom fonts for the editor UI to maintain brand consistency.',
imageId: 'text-editing',
},
{
title: 'Component Styling',
description:
'Customize the appearance of buttons, panels, and other UI components.',
imageId: 'asset-libraries',
},
{
title: 'Full Design Editing',
description:
'Complete design editor capabilities with your custom themed appearance.',
imageId: 'client-side',
},
]}
/>
