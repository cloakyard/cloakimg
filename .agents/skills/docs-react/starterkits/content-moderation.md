...
**Navigation:** [Starter Kits](./starterkits.md) > [Extensibility](./starterkits/extensibility.md) > [Content Moderation](./starterkits/content-moderation.md)
...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-content-moderation-react-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-content-moderation-react-web/tree/v$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-content-moderation-react-web/tree/v$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-content-moderation/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-content-moderation-react-web starterkit-content-moderation-react-web
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Content Moderation Editor into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        rm -rf starterkit-content-moderation-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-content-moderation-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export default function DesignEditor() {
      return (
        <CreativeEditor
          ...
          init={initContentModerationEditor}
          width="100vw"
          height="100vh"
        />
      );
...
```typescript title="src/moderation.ts"
import type { CreativeEngine } from "@cesdk/cesdk-js";

import { getImageUrl } from "./imgly/utils";

// Check all images in the scene
export async function checkImageContent(engine: CreativeEngine): Promise<ModerationResult[]> {
...
export async function checkImageContentAPI(url: string): Promise<ModerationCheckResult[]> {
...
```typescript title="src/imgly/utils.ts"
import type { CreativeEngine } from "@cesdk/cesdk-js";
...
```typescript title="src/app/publish.ts"
...
```typescript title="src/app/adValidation.ts"
