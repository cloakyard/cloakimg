...
**Navigation:** [Starter Kits](./starterkits.md) > [Design Editor](./starterkits/design-editor.md)

---

Professional design editing for your React app—create graphics, templates, and
multi-page documents. Runs entirely in the browser with no server
dependencies.
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-design-editor/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new React application with Design Editor integration.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-design-editor-ts-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Editor into an existing React application. This adds the editor configuration to your current project structure.
