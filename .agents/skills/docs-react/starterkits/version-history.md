...
**Navigation:** [Starter Kits](./starterkits.md) > [Extensibility](./starterkits/extensibility.md) > [Version History](./starterkits/version-history.md)
...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-version-history-react-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-version-history-react-web/tree/v$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-version-history-react-web/tree/v$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-version-history/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-version-history-react-web starterkit-version-history-react-web
      </TerminalTab>
    </TerminalTabs>
    ...
    > **Asset Configuration:** The starter kit is pre-configured to load assets from `/assets`. If you place assets in a different location, update the `baseURL` in `src/app/App.tsx`.
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Version History into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-version-history-react-web.git
        cp -r starterkit-version-history-react-web/src/imgly ./src/imgly
        rm -rf starterkit-version-history-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-version-history-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    import { initVersionHistoryEditor } from './imgly';

    export default function DesignEditor() {
      return (
        <CreativeEditor
          config={{ baseURL: '/assets' }}
          init={initVersionHistoryEditor}
          width="100vw"
          height="100vh"
        />
      );
...
```typescript title="src/imgly/history.ts"
