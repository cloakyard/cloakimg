...
**Navigation:** [Starter Kits](./starterkits.md) > [T-Shirt Designer](./starterkits/t-shirt-designer.md)
...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-t-shirt-designer/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone T-Shirt Designer project. This creates a complete, ready-to-run application.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-t-shirt-designer-react-web starterkit-t-shirt-designer-react-web
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the T-Shirt Designer into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-t-shirt-designer-react-web.git
        cp -r starterkit-t-shirt-designer-react-web/src/imgly ./src/imgly
        rm -rf starterkit-t-shirt-designer-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-t-shirt-designer-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
...
The T-Shirt Designer includes everything needed for t-shirt customization and e-commerce integration.

<CapabilityGrid
features={[
{
title: 'Front & Back Print Areas',
description:
'Design on both sides with easy area switching and isolated canvas pages.',
imageId: 'transform',
},
{
title: '10 Color Options',
description:
'Choose from 10 t-shirt colors with real-time mockup preview updates.',
imageId: 'filters',
},
{
title: 'Size & Quantity Selection',
description:
'XS to XL sizing with quantity counters and automatic price calculation.',
imageId: 'client-side',
},
{
title: 'Real-time Mockup Preview',
description:
'See designs on realistic t-shirt mockups that update instantly.',
...
description:
'Export PDF files and PNG thumbnails for all print areas.',
