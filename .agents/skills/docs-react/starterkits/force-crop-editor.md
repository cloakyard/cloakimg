...
**Navigation:** [Starter Kits](./starterkits.md) > [Customization](./starterkits/customization.md) > [Force Crop Editor](./starterkits/force-crop-editor.md)

---

Start editing with predefined crop presets to simplify content creation and maintain layout consistency.
...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-force-crop-editor-react-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-force-crop-editor-react-web/tree/v$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-force-crop-editor-react-web/tree/v$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-force-crop-editor/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Force Crop Editor project. This creates a complete, ready-to-run application.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-force-crop-editor-react-web starterkit-force-crop-editor-react-web
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Force Crop Editor into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-force-crop-editor-react-web.git
        cp -r starterkit-force-crop-editor-react-web/src/imgly ./src/imgly
        rm -rf starterkit-force-crop-editor-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-force-crop-editor-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    import { initForceCropEditor } from './imgly';

    export default function DesignEditor() {
      return (
        <CreativeEditor
          config={{ baseURL: '/assets' }}
          init={initForceCropEditor}
          width="100vw"
          height="100vh"
        />
      );
...
The Force Crop Editor uses asset source plugins to provide built-in libraries for templates, stickers, shapes, and fonts. The starter kit includes a curated selection—customize what's included based on your needs.
...
The Force Crop Editor includes everything needed for professional design editing.
