...
**Navigation:** [Starter Kits](./starterkits.md) > [Customization](./starterkits/customization.md) > [Video Export Options](./starterkits/video-export-options.md)

---

Choose a suitable Frames per Second option and export videos in SD, HD, FHD, 2K, 4K, or define custom quality.

![Video Export Options starter kit showing a professional video editing interface](https://img.ly/docs/cesdk/./assets/browser.hero.webp)

> **Reading time:** 10 minutes
>
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-video-export-options-ts-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-video-export-options-ts-web/tree/release-$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-video-export-options-ts-web/tree/release-$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-video-export-options/index.html)
...
Integrate the Video Export Options into your React application using the official React wrapper.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-video-export-options-ts-web/src/imgly ./src/imgly
        rm -rf starterkit-video-export-options-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-video-export-options-ts-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export default function VideoExportOptionsEditor() {
      return (
        <CreativeEditor
          config={{ baseURL: '/assets' }}
          init={initVideoExportOptionsEditor}
          width="100vw"
          height="100vh"
        />
      );
    ...
    Import and use the Video Export Options component in your application:

    ```tsx
    import VideoExportOptionsEditor from './components/VideoExportOptionsEditor';

    function App() {
      return <VideoExportOptionsEditor />;
    }
  ...
  <TabItem label="Existing Project">
    ...
    Copy the Video Export Options configuration to your project:
...
The Video Export Options uses asset source plugins to provide built-in libraries for video clips, audio, effects, stickers, and fonts. The starter kit includes a curated selection—customize what's included based on your needs.
...
Customize actions in `src/imgly/config/actions.ts`:
...
The Video Export Options includes everything needed for professional video editing.
