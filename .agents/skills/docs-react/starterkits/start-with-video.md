...
**Navigation:** [Starter Kits](./starterkits.md) > [Video Editing](./starterkits/video-editing.md) > [Start with Video](./starterkits/start-with-video.md)

---

Initialize the editor with a video matching the page size.
...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-start-with-video-react-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-start-with-video-react-web/tree/v$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-start-with-video-react-web/tree/v$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-start-with-video/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Start with Video project. This creates a complete, ready-to-run application.

    ## Step 1: Clone the Repository

    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-start-with-video-react-web.git
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-start-with-video-react-web starterkit-start-with-video-react-web
      </TerminalTab>
    </TerminalTabs>
    ...
    <TerminalTabs syncKey="package-manager">
      <TerminalTab label="npm">
        cd starterkit-start-with-video-react-web
        npm install
      </TerminalTab>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Start with Video into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-start-with-video-react-web.git
        cp -r starterkit-start-with-video-react-web/src/imgly ./src/imgly
        rm -rf starterkit-start-with-video-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-start-with-video-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
...
The Start with Video uses asset source plugins to provide built-in libraries for video clips, audio, effects, stickers, and fonts. The starter kit includes a curated selection—customize what's included based on your needs.
...
The Start with Video includes everything needed for professional video editing.
