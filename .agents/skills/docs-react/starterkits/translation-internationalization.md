...
**Navigation:** [Starter Kits](./starterkits.md) > [Customization](./starterkits/customization.md) > [Translation & Internationalization](./starterkits/translation-internationalization.md)

---

Ships with English and German. Supports translations for any language.
...
> **Resources:**
>
> - [Download examples](https://github.com/imgly/starterkit-translation-internationalization-react-web/archive/refs/tags/release-$UBQ_VERSION$.zip)
>
> - [View source on GitHub](https://github.com/imgly/starterkit-translation-internationalization-react-web/tree/v$UBQ_VERSION$)
>
> - [Open in StackBlitz](https://stackblitz.com/github/imgly/starterkit-translation-internationalization-react-web/tree/v$UBQ_VERSION$)
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-translation-internationalization/index.html)
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Start fresh with a standalone Translation & Internationalization project. This creates a complete, ready-to-run application with locale switching.
    ...
    <TerminalTabs>
      ...
      <TerminalTab label="degit">
        npx degit imgly/starterkit-translation-internationalization-react-web starterkit-translation-internationalization-react-web
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Translation the Design Editor Internationalization into an existing React application. This adds the editor configuration to your current project structure.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-translation-internationalization-react-web.git
        cp -r starterkit-translation-internationalization-react-web/src/imgly ./src/imgly
        rm -rf starterkit-translation-internationalization-react-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-translation-internationalization-react-web/src/imgly ./src/imgly
      </TerminalTab>
    </TerminalTabs>
    ...
    export default function DesignEditor() {
      return (
        <CreativeEditor
          ...
          init={initTranslationInternationalizationEditor}
          width="100vw"
          height="100vh"
        />
      );
...
The Translation & Internationalization Editor uses asset source plugins to provide built-in libraries for templates, stickers, shapes, and fonts. The starter kit includes a curated selection—customize what's included based on your needs.
...
The Translation & Internationalization Editor includes everything needed for multi-language design editing.
...
description:
'Switch between languages instantly with real-time UI updates. Built-in support for English and German.',
imageId: 'client-side',
},
{
