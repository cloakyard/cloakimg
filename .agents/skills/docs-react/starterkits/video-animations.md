...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/starterkit-video-animations/index.html)
...
Integrate the Video Animations into your React application using the official React wrapper.
...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    export default function VideoAnimationsEditor() {
      return (
        <CreativeEditor
          config={{ baseURL: '/assets' }}
          init={initVideoAnimationsEditor}
          width="100vw"
          height="100vh"
        />
      );
    ...
    Import and use the Video Animations component in your application:

    ```tsx
    import VideoAnimationsEditor from './components/VideoAnimationsEditor';

    function App() {
      return <VideoAnimationsEditor />;
    }
  ...
  <TabItem label="Existing Project">
    ...
    Copy the Video Animations configuration to your project:
