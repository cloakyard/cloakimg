...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-use-templates-library-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const allCustomTemplates = await engine.asset.findAssets("my.custom.templates", {
      page: 0,
      perPage: 100,
    });
...
engine.asset.addAssetToSource("my.custom.templates", {
  ...
  groups: ["cards"],
  meta: {
    thumbUri: "https://cdn.img.ly/assets/demo/v3/ly.img.template/thumbnails/cesdk_postcard_1.jpg",
    uri: "https://cdn.img.ly/packages/imgly/cesdk-js/latest/assets/templates/cesdk_postcard_1.scene",
  },
});
...
engine.asset.addAssetToSource("my.custom.templates", {
  ...
  groups: ["business"],
  meta: {
    thumbUri: "https://cdn.img.ly/assets/demo/v3/ly.img.template/thumbnails/cesdk_postcard_2.jpg",
    uri: "https://cdn.img.ly/packages/imgly/cesdk-js/latest/assets/templates/cesdk_postcard_2.scene",
  },
});
```
