...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-stickers-and-shapes-combine-browser/index.html)

CE.SDK provides four boolean operations for combining shapes: _Union_, _Difference_, _Intersection_, and _XOR_. These operations work with graphic blocks and text blocks, allowing you to build complex designs from simple primitives.
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.block.setShape(unionCircle1, engine.block.createShape("//ly.img.ubq/shape/ellipse"));
    ...
    engine.block.setShape(unionCircle2, engine.block.createShape("//ly.img.ubq/shape/ellipse"));
    ...
    engine.block.setShape(unionCircle3, engine.block.createShape("//ly.img.ubq/shape/ellipse"));
    ...
    engine.block.setShape(intersectCircle1, engine.block.createShape("//ly.img.ubq/shape/ellipse"));
    ...
    engine.block.setShape(intersectCircle2, engine.block.createShape("//ly.img.ubq/shape/ellipse"));
    ...
    engine.block.setShape(xorCircle1, engine.block.createShape("//ly.img.ubq/shape/ellipse"));
    ...
    engine.block.setShape(xorCircle2, engine.block.createShape("//ly.img.ubq/shape/ellipse"));
    ...
    const textX =
      imageX + (engine.block.getWidth(imageBlock) - engine.block.getWidth(textBlock)) / 2;
    const textY =
      imageY + (engine.block.getHeight(imageBlock) - engine.block.getHeight(textBlock)) / 2;
    ...
    const canCombineUnion = engine.block.isCombinable([unionCircle1, unionCircle2, unionCircle3]);
    const canCombineDiff = engine.block.isCombinable([imageBlock, textBlock]);
    const canCombineIntersect = engine.block.isCombinable([intersectCircle1, intersectCircle2]);
