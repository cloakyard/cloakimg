...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-appearance-change-ui-font-browser/index.html)
...
@font-face {
  font-family: "CustomFont";
  src:
    url("/fonts/CustomFont-SemiBold.woff2") format("woff2"),
...
```javascript
getComputedStyle(document.querySelector(".ubq-public")).getPropertyValue(
  "--ubq-typography-font_family",
);
```
