...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-appearance-icons-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.ui.registerComponent("CustomIconButton", ({ builder: { Button } }) => {
      Button("heartButton", {
        label: "Heart",
