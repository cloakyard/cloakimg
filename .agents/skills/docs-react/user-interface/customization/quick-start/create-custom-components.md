...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-customization-quick-start-create-custom-components-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.ui.insertOrderComponent({ in: "ly.img.navigation.bar" }, "my.themeToggle");
    ...
    cesdk.ui.insertOrderComponent({ in: "ly.img.dock" }, ["ly.img.spacer", "my.quickActions"]);
    ...
    cesdk.ui.registerComponent("my.controls", ({ builder, state }) => {
      ...
      const { value: isEnabled, setValue: setIsEnabled } = state("isEnabled", false);
    ...
    cesdk.ui.insertOrderComponent({ in: "ly.img.canvas.bar", at: "top" }, "my.controls");
