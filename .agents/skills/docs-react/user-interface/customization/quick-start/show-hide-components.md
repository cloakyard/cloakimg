...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-customization-quick-start-show-hide-components-browser/index.html)
...
console.log(`Removed crop controls in Transform mode: ${conditionalResult.removed} component(s)`);
```
