...
cesdk.ui.updateOrderComponent({ in: "*", match: "ly.img.separator" }, { disabled: true });
...
cesdk.ui.setComponentOrder({ in: "ly.img.dock", at: "right" }, ["ly.img.assetLibrary.dock"]);

// Place dock at the bottom
cesdk.ui.setComponentOrder({ in: "ly.img.dock", at: "bottom" }, ["ly.img.assetLibrary.dock"]);
...
// Insert at start
cesdk.ui.insertOrderComponent({ in: "ly.img.dock", position: "start" }, "my.first.button");
