...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-customization-dock-browser/index.html)
...
cesdk.ui.setComponentOrder({ in: "ly.img.dock", at: "left" }, ["ly.img.assetLibrary.dock"]);

// Secondary tools on the right
cesdk.ui.setComponentOrder({ in: "ly.img.dock", at: "right" }, ["my.custom.tool"]);
```
