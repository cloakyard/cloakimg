...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-keyboard-browser/index.html)
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.shortcuts.set({
      ...
      when: ({ cesdk }) => {
        ...
        return selected.every((id) => cesdk.engine.block.getType(id) === "//ly.img.ubq/text");
      },
    });
