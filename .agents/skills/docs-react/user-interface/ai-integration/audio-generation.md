...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-ai-integration-audio-generation-browser/index.html)
...
cesdk.i18n.setTranslations({
  en: {
    "ly.img.plugin-ai-generation-web.property.prompt": "Describe the audio you want to generate",
