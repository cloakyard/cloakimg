...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-ai-integration-custom-provider-browser/index.html)
...
async function mockGenerateImage(
  ...
  const sampleImages: Record<string, string> = {
    photorealistic: "https://cdn.img.ly/assets/demo/v3/ly.img.image/images/sample_1.jpg",
    cartoon: "https://cdn.img.ly/assets/demo/v3/ly.img.image/images/sample_2.jpg",
    sketch: "https://cdn.img.ly/assets/demo/v3/ly.img.image/images/sample_3.jpg",
    painting: "https://cdn.img.ly/assets/demo/v3/ly.img.image/images/sample_4.jpg",
  };
...
function configureFeatures(cesdk: CreativeEditorSDK) {
  ...
  cesdk.feature.set("ly.img.plugin-ai-image-generation-web.providerSelect", () => false);
  // Enable text-to-image generation
  cesdk.feature.set("ly.img.plugin-ai-image-generation-web.fromText", () => true);
  // Disable image-to-image generation
  cesdk.feature.set("ly.img.plugin-ai-image-generation-web.fromImage", () => false);
}
