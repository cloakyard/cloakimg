...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-ai-integration-text-generation-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.i18n.setTranslations({
      en: {
        "ly.img.plugin-ai-text-generation-web.anthropic.quickAction.improve": "✨ Enhance Text",
...
cesdk.i18n.setTranslations({
  en: {
    "ly.img.plugin-ai-text-generation-web.anthropic.quickAction.improve": "✨ Enhance Text",
    "ly.img.plugin-ai-text-generation-web.anthropic.property.prompt": "Your Custom Instructions",
  },
});
```
