...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-ai-integration-browser/index.html)
...
// Control AI features with Feature API
// Disable specific quick actions
cesdk.feature.set("ly.img.plugin-ai-image-generation-web.quickAction.editImage", () => false);
cesdk.feature.set("ly.img.plugin-ai-text-generation-web.quickAction.translate", () => false);
