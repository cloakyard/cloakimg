...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-localization-browser/index.html)
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.i18n.setTranslations({
      it: {
        ...
        "component.settings.toggle.description": "Apri impostazioni per personalizzare l'editor",
