...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-ui-extensions-quick-actions-browser/index.html)
...
export default class QuickActionsExample implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext) {
    ...
    const totalHeight = titleHeight + textSpacing + subtitleHeight + imageGap + imageSize;
