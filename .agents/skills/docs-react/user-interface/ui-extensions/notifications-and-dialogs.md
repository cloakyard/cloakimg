...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-ui-extensions-notifications-and-dialogs-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    cesdk.ui.registerComponent("ly.img.notifications.demo.navigationBar", ({ builder }) => {
    ...
    cesdk.ui.registerComponent("ly.img.dialogs.demo.navigationBar", ({ builder }) => {
      ...
      builder.Button("close-dialog", {
        label: "Auto-Close",
        onClick: () => {
          const dialogId = cesdk.ui.showDialog("This dialog will close in 2 seconds");
          setTimeout(() => {
