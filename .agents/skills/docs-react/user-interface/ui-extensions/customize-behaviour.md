...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-ui-extensions-customize-behaviour-browser/index.html)
...
export default class CustomizeBehaviorExample implements EditorPlugin {
  ...
  private demonstrateEventSubscription(engine: CreativeEngine, cesdk: any): void {
  ...
  private demonstrateDialogs(cesdk: CreativeEditorSDK, engine: CreativeEngine): void {
  ...
  async demonstrateExternalIntegration(engine: CreativeEngine, cesdk: any): Promise<void> {
  ...
  private demonstrateContextAwareWorkflow(engine: CreativeEngine, cesdk: any): void {
