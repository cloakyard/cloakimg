...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-ui-extensions-asset-library-browser/index.html)
...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.asset.addLocalSource("user-uploads", ["image/jpeg", "image/png", "image/webp"]);
    ...
    engine.asset.registerApplyMiddleware(async (sourceId, assetResult, apply, _context) => {
