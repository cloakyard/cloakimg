...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-user-interface-build-your-own-ui-browser/index.html)
...
import CreativeEngine, { type BlockEvent, type DesignBlockId } from "@cesdk/engine";
