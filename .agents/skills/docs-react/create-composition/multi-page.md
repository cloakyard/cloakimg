...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-composition-multi-page-browser/index.html)
...
// Add a different image to the second page
const imageBlock2 = await engine.block.addImage("https://img.ly/static/ubq_samples/sample_2.jpg", {
  size: { width: 300, height: 200 },
});
engine.block.setPositionX(imageBlock2, 250);
engine.block.setPositionY(imageBlock2, 200);
