...
>
> - [Live demo](https://cdn.img.ly/demo/cesdk-web-examples/v1.79.0/examples/guides-create-composition-lock-design-browser/index.html)
...
class LockDesign implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    const canReplacePlaceholder = engine.block.isAllowedByScope(placeholderBlock, "fill/change");
